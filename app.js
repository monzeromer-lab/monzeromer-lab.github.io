...
(function() {
  ...
  _app.innerHTML = '';
  const _e232 = WF.h("div", { className: "wf-row wf-row--center wf-row--between" });
  const _e233 = WF.h("a", { className: "wf-link", href: WF._basePath + "/" });
  const _e234 = WF.h("p", { className: "wf-text wf-text--bold" }, "monzer.omer");
  _e234.style.fontFamily = "JetBrains Mono, monospace";
  _e234.style.color = "#E8E6E1";
  _e234.style.fontSize = "0.9rem";
  _e234.style.fontWeight = "600";
  _e233.appendChild(_e234);
  _e232.appendChild(_e233);
  const _e235 = WF.h("button", { className: "wf-btn wf-btn--small wf-btn--outlined", "on:click": (e) => { NavStore.toggle(); } }, "Menu");
  _e235.style.color = "#8C8B88";
  _e235.style.background = "transparent";
  _e235.style.border = "1px solid #2D2C2A";
  _e235.style.cursor = "pointer";
  _e235.style.fontFamily = "JetBrains Mono, monospace";
  _e235.style.fontSize = "0.75rem";
  _e235.style.padding = "0.35rem 0.75rem";
  _e235.style.borderRadius = "0.375rem";
  _e232.appendChild(_e235);
  _e232.style.display = "none";
  _e232.style.background = "#1A1A19";
  _e232.style.borderBottom = "1px solid #2D2C2A";
  _e232.style.padding = "0.75rem 1.25rem";
  _e232.style.position = "sticky";
  _e232.style.top = "0";
  _e232.style.zIndex = "200";
  _e232.style.flexDirection = "row";
  _e232.classList.add("wf-s236");
  { const _s = document.createElement('style'); _s.textContent = "@media (max-width: 768px) { .wf-s236 { display: flex; } } "; document.head.appendChild(_s); }
  _app.appendChild(_e232);
  WF.condRender(_app,
    () => NavStore.sidebarOpen,
    () => {
      const _e237 = document.createDocumentFragment();
      const _e238 = WF.h("div", { className: "wf-container", "on:click": (event) => { NavStore.close(); } });
      _e238.style.position = "fixed";
      _e238.style.top = "0";
      _e238.style.left = "0";
      _e238.style.right = "0";
      _e238.style.bottom = "0";
      _e238.style.background = "rgba(0, 0, 0, 0.5)";
      _e238.style.zIndex = "399";
      _e238.style.maxWidth = "100%";
      _e238.style.padding = "0";
      _e237.appendChild(_e238);
      const _e239 = WF.h("div", { className: "wf-container" });
      const _e240 = WF.h("div", { className: "wf-container" });
      const _e241 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
      const _e242 = WF.h("a", { className: "wf-link", href: WF._basePath + "/", "on:click": (event) => { NavStore.close(); } });
      const _e243 = WF.h("p", { className: "wf-text wf-text--bold" }, "monzer.omer");
      _e243.style.fontFamily = "JetBrains Mono, monospace";
      _e243.style.color = "#E8E6E1";
      _e243.style.fontSize = "1rem";
      _e243.style.fontWeight = "600";
      _e242.appendChild(_e243);
      _e241.appendChild(_e242);
      const _e244 = WF.h("p", { className: "wf-text wf-text--muted" }, "Senior Backend Engineer");
      _e244.style.color = "#8C8B88";
      _e244.style.fontSize = "0.75rem";
      _e241.appendChild(_e244);
      _e240.appendChild(_e241);
      _e240.style.padding = "1.5rem";
      _e240.style.borderBottom = "1px solid #2D2C2A";
      _e240.style.maxWidth = "100%";
      _e239.appendChild(_e240);
      const _e245 = WF.h("div", { className: "wf-stack" });
      const _e246 = WF.h("a", { className: "wf-link", href: WF._basePath + "/", "on:click": (event) => { NavStore.close(); } });
      const _e247 = WF.h("p", { className: "wf-text" }, "Home");
      _e247.style.display = "block";
      _e247.style.padding = "0.6rem 1.5rem";
      _e247.style.color = "#8C8B88";
      _e247.style.fontSize = "0.9rem";
      _e246.appendChild(_e247);
      _e245.appendChild(_e246);
      const _e248 = WF.h("a", { className: "wf-link", href: WF._basePath + "/projects", "on:click": (event) => { NavStore.close(); } });
      const _e249 = WF.h("p", { className: "wf-text" }, "Projects");
      _e249.style.display = "block";
      _e249.style.padding = "0.6rem 1.5rem";
      _e249.style.color = "#8C8B88";
      _e249.style.fontSize = "0.9rem";
      _e248.appendChild(_e249);
      _e245.appendChild(_e248);
      const _e250 = WF.h("a", { className: "wf-link", href: WF._basePath + "/experience", "on:click": (event) => { NavStore.close(); } });
      const _e251 = WF.h("p", { className: "wf-text" }, "Experience");
      _e251.style.display = "block";
      _e251.style.padding = "0.6rem 1.5rem";
      _e251.style.color = "#8C8B88";
      _e251.style.fontSize = "0.9rem";
      _e250.appendChild(_e251);
      _e245.appendChild(_e250);
      const _e252 = WF.h("a", { className: "wf-link", href: WF._basePath + "/skills", "on:click": (event) => { NavStore.close(); } });
      const _e253 = WF.h("p", { className: "wf-text" }, "Skills");
      _e253.style.display = "block";
      _e253.style.padding = "0.6rem 1.5rem";
      _e253.style.color = "#8C8B88";
      _e253.style.fontSize = "0.9rem";
      _e252.appendChild(_e253);
      _e245.appendChild(_e252);
      const _e254 = WF.h("a", { className: "wf-link", href: WF._basePath + "/education", "on:click": (event) => { NavStore.close(); } });
      const _e255 = WF.h("p", { className: "wf-text" }, "Education");
      _e255.style.display = "block";
      _e255.style.padding = "0.6rem 1.5rem";
      _e255.style.color = "#8C8B88";
      _e255.style.fontSize = "0.9rem";
      _e254.appendChild(_e255);
      _e245.appendChild(_e254);
      const _e256 = WF.h("a", { className: "wf-link", href: WF._basePath + "/contact", "on:click": (event) => { NavStore.close(); } });
      const _e257 = WF.h("p", { className: "wf-text" }, "Contact");
      _e257.style.display = "block";
      _e257.style.padding = "0.6rem 1.5rem";
      _e257.style.color = "#8C8B88";
      _e257.style.fontSize = "0.9rem";
      _e256.appendChild(_e257);
      _e245.appendChild(_e256);
      _e245.style.padding = "1rem 0";
      _e245.style.gap = "2px";
      _e239.appendChild(_e245);
      const _e258 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
      const _e259 = WF.h("div", { className: "wf-row wf-row--gap-md" });
      ...
      const _e262 = WF.h("a", { className: "wf-link", href: WF._basePath + "https://www.linkedin.com/in/monzeromer/" });
      const _e263 = WF.h("p", { className: "wf-text" }, "LinkedIn");
      _e263.style.fontFamily = "JetBrains Mono, monospace";
      _e263.style.color = "#8C8B88";
      _e263.style.fontSize = "0.75rem";
      _e262.appendChild(_e263);
      _e259.appendChild(_e262);
      _e258.appendChild(_e259);
      const _e264 = WF.h("p", { className: "wf-text wf-text--muted" }, "Built with WebFluent");
      _e264.style.fontFamily = "JetBrains Mono, monospace";
      _e264.style.color = "#555";
      _e264.style.fontSize = "0.7rem";
      _e264.style.marginTop = "0.5rem";
      _e258.appendChild(_e264);
      _e258.style.padding = "1rem 1.5rem";
      _e258.style.marginTop = "auto";
      _e258.style.borderTop = "1px solid #2D2C2A";
      _e239.appendChild(_e258);
      _e239.style.position = "fixed";
      _e239.style.top = "0";
      _e239.style.left = "0";
      _e239.style.bottom = "0";
      _e239.style.width = "260px";
      _e239.style.maxWidth = "80vw";
      _e239.style.zIndex = "400";
      _e239.style.padding = "0";
      _e239.style.background = "#1A1A19";
      _e239.style.borderRight = "1px solid #2D2C2A";
      _e239.style.overflowY = "auto";
      _e239.style.display = "flex";
      _e239.style.flexDirection = "column";
  ...
  const _e265 = WF.h("div", { className: "wf-row" });
  _e265.style.minHeight = "100vh";
  _e265.style.flexDirection = "row";
  _e265.style.flexWrap = "nowrap";
  _app.appendChild(_e265);
  const _e266 = WF.h("div", { className: "wf-container" });
  const _e267 = WF.h("div", { className: "wf-container" });
  const _e268 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
  const _e269 = WF.h("a", { className: "wf-link", href: WF._basePath + "/" });
  const _e270 = WF.h("p", { className: "wf-text wf-text--bold" }, "monzer.omer");
  _e270.style.fontFamily = "JetBrains Mono, monospace";
  _e270.style.color = "#E8E6E1";
  _e270.style.fontSize = "1rem";
  _e270.style.fontWeight = "600";
  _e269.appendChild(_e270);
  _e268.appendChild(_e269);
  const _e271 = WF.h("p", { className: "wf-text wf-text--muted" }, "Senior Backend Engineer");
  _e271.style.color = "#8C8B88";
  _e271.style.fontSize = "0.75rem";
  _e268.appendChild(_e271);
  _e267.appendChild(_e268);
  _e267.style.padding = "1.5rem";
  _e267.style.borderBottom = "1px solid #2D2C2A";
  _e267.style.maxWidth = "100%";
  _e266.appendChild(_e267);
  const _e272 = WF.h("div", { className: "wf-stack" });
  const _e273 = WF.h("a", { className: "wf-link", href: WF._basePath + "/" });
  const _e274 = WF.h("p", { className: "wf-text" }, "Home");
  _e274.style.display = "block";
  _e274.style.padding = "0.55rem 1.5rem";
  _e274.style.color = "#8C8B88";
  _e274.style.fontSize = "0.875rem";
  _e273.appendChild(_e274);
  _e272.appendChild(_e273);
  const _e275 = WF.h("a", { className: "wf-link", href: WF._basePath + "/projects" });
  const _e276 = WF.h("p", { className: "wf-text" }, "Projects");
  _e276.style.display = "block";
  _e276.style.padding = "0.55rem 1.5rem";
  _e276.style.color = "#8C8B88";
  _e276.style.fontSize = "0.875rem";
  _e275.appendChild(_e276);
  _e272.appendChild(_e275);
  const _e277 = WF.h("a", { className: "wf-link", href: WF._basePath + "/experience" });
  const _e278 = WF.h("p", { className: "wf-text" }, "Experience");
  _e278.style.display = "block";
  _e278.style.padding = "0.55rem 1.5rem";
  _e278.style.color = "#8C8B88";
  _e278.style.fontSize = "0.875rem";
  _e277.appendChild(_e278);
  _e272.appendChild(_e277);
  const _e279 = WF.h("a", { className: "wf-link", href: WF._basePath + "/skills" });
  const _e280 = WF.h("p", { className: "wf-text" }, "Skills");
  _e280.style.display = "block";
  _e280.style.padding = "0.55rem 1.5rem";
  _e280.style.color = "#8C8B88";
  _e280.style.fontSize = "0.875rem";
  _e279.appendChild(_e280);
  _e272.appendChild(_e279);
  const _e281 = WF.h("a", { className: "wf-link", href: WF._basePath + "/education" });
  const _e282 = WF.h("p", { className: "wf-text" }, "Education");
  _e282.style.display = "block";
  _e282.style.padding = "0.55rem 1.5rem";
  _e282.style.color = "#8C8B88";
  _e282.style.fontSize = "0.875rem";
  _e281.appendChild(_e282);
  _e272.appendChild(_e281);
  const _e283 = WF.h("a", { className: "wf-link", href: WF._basePath + "/contact" });
  const _e284 = WF.h("p", { className: "wf-text" }, "Contact");
  _e284.style.display = "block";
  _e284.style.padding = "0.55rem 1.5rem";
  _e284.style.color = "#8C8B88";
  _e284.style.fontSize = "0.875rem";
  _e283.appendChild(_e284);
  _e272.appendChild(_e283);
  _e272.style.padding = "1rem 0";
  _e272.style.gap = "2px";
  _e266.appendChild(_e272);
  const _e285 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
  const _e286 = WF.h("div", { className: "wf-row wf-row--gap-md" });
  const _e287 = WF.h("a", { className: "wf-link", href: WF._basePath + "https://github.com/monzeromer-lab" });
  const _e288 = WF.h("p", { className: "wf-text" }, "GitHub");
  _e288.style.fontFamily = "JetBrains Mono, monospace";
  _e288.style.color = "#8C8B88";
  _e288.style.fontSize = "0.75rem";
  _e287.appendChild(_e288);
  _e286.appendChild(_e287);
  const _e289 = WF.h("a", { className: "wf-link", href: WF._basePath + "https://www.linkedin.com/in/monzeromer/" });
  const _e290 = WF.h("p", { className: "wf-text" }, "LinkedIn");
  _e290.style.fontFamily = "JetBrains Mono, monospace";
  _e290.style.color = "#8C8B88";
  _e290.style.fontSize = "0.75rem";
  _e289.appendChild(_e290);
  _e286.appendChild(_e289);
  _e285.appendChild(_e286);
  const _e291 = WF.h("p", { className: "wf-text wf-text--muted" }, "Built with WebFluent");
  _e291.style.fontFamily = "JetBrains Mono, monospace";
  _e291.style.color = "#555";
  _e291.style.fontSize = "0.7rem";
  _e291.style.marginTop = "0.5rem";
  _e285.appendChild(_e291);
  _e285.style.padding = "1rem 1.5rem";
  _e285.style.marginTop = "auto";
  _e285.style.borderTop = "1px solid #2D2C2A";
  _e266.appendChild(_e285);
  _e266.style.width = "220px";
  _e266.style.minWidth = "220px";
  _e266.style.maxWidth = "220px";
  _e266.style.padding = "0";
  _e266.style.position = "sticky";
  _e266.style.top = "0";
  _e266.style.height = "100vh";
  _e266.style.background = "#1A1A19";
  _e266.style.borderRight = "1px solid #2D2C2A";
  _e266.style.overflowY = "auto";
  _e266.style.display = "flex";
  _e266.style.flexDirection = "column";
  _e266.style.flexShrink = "0";
  _e266.classList.add("wf-s292");
  { const _s = document.createElement('style'); _s.textContent = "@media (max-width: 768px) { .wf-s292 { display: none; } } "; document.head.appendChild(_s); }
  _e265.appendChild(_e266);
  const _e293 = WF.h("div", { className: "wf-container" });
  _e293.style.flex = "1";
  _e293.style.maxWidth = "100%";
  _e293.style.minHeight = "100vh";
  _e293.style.padding = "0";
  _e293.style.minWidth = "0";
  _e265.appendChild(_e293);
  const _routerEl = document.createElement('div');
  _routerEl.id = 'wf-router';
  _routerEl.style.flex = '1';
  _e293.appendChild(_routerEl);
  const _routes = [
