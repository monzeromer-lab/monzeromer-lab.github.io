...
(function() {
  ...
  const _e238 = WF.h("div", { className: "wf-stack" });
  const _e239 = WF.h("a", { className: "wf-link", href: WF._basePath + "/" });
  const _e240 = WF.h("p", { className: "wf-text" }, "Home");
  _e240.style.display = "block";
  _e240.style.padding = "0.55rem 1.5rem";
  _e240.style.color = "#8C8B88";
  _e240.style.fontSize = "0.875rem";
  _e240.style.cursor = "pointer";
  _e239.appendChild(_e240);
  _e238.appendChild(_e239);
  const _e241 = WF.h("a", { className: "wf-link", href: WF._basePath + "/projects" });
  const _e242 = WF.h("p", { className: "wf-text" }, "Projects");
  _e242.style.display = "block";
  _e242.style.padding = "0.55rem 1.5rem";
  _e242.style.color = "#8C8B88";
  _e242.style.fontSize = "0.875rem";
  _e242.style.cursor = "pointer";
  _e241.appendChild(_e242);
  _e238.appendChild(_e241);
  const _e243 = WF.h("a", { className: "wf-link", href: WF._basePath + "/experience" });
  const _e244 = WF.h("p", { className: "wf-text" }, "Experience");
  _e244.style.display = "block";
  _e244.style.padding = "0.55rem 1.5rem";
  _e244.style.color = "#8C8B88";
  _e244.style.fontSize = "0.875rem";
  _e244.style.cursor = "pointer";
  _e243.appendChild(_e244);
  _e238.appendChild(_e243);
  const _e245 = WF.h("a", { className: "wf-link", href: WF._basePath + "/skills" });
  const _e246 = WF.h("p", { className: "wf-text" }, "Skills");
  _e246.style.display = "block";
  _e246.style.padding = "0.55rem 1.5rem";
  _e246.style.color = "#8C8B88";
  _e246.style.fontSize = "0.875rem";
  _e246.style.cursor = "pointer";
  _e245.appendChild(_e246);
  _e238.appendChild(_e245);
  const _e247 = WF.h("a", { className: "wf-link", href: WF._basePath + "/education" });
  const _e248 = WF.h("p", { className: "wf-text" }, "Education");
  _e248.style.display = "block";
  _e248.style.padding = "0.55rem 1.5rem";
  ...
  const _e249 = WF.h("a", { className: "wf-link", href: WF._basePath + "/contact" });
  const _e250 = WF.h("p", { className: "wf-text" }, "Contact");
  _e250.style.display = "block";
  _e250.style.padding = "0.55rem 1.5rem";
  _e250.style.color = "#8C8B88";
  _e250.style.fontSize = "0.875rem";
  _e250.style.cursor = "pointer";
  _e249.appendChild(_e250);
  _e238.appendChild(_e249);
  _e238.style.padding = "1rem 0";
  _e238.style.gap = "2px";
  _e232.appendChild(_e238);
  const _e251 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
  const _e252 = WF.h("div", { className: "wf-row wf-row--gap-md" });
  const _e253 = WF.h("a", { className: "wf-link", href: WF._basePath + "https://github.com/monzeromer-lab" });
  const _e254 = WF.h("p", { className: "wf-text" }, "GitHub");
  _e254.style.fontFamily = "JetBrains Mono, monospace";
  _e254.style.color = "#8C8B88";
  _e254.style.fontSize = "0.75rem";
  _e253.appendChild(_e254);
  _e252.appendChild(_e253);
  const _e255 = WF.h("a", { className: "wf-link", href: WF._basePath + "https://www.linkedin.com/in/monzeromer/" });
  const _e256 = WF.h("p", { className: "wf-text" }, "LinkedIn");
  _e256.style.fontFamily = "JetBrains Mono, monospace";
  _e256.style.color = "#8C8B88";
  _e256.style.fontSize = "0.75rem";
  _e255.appendChild(_e256);
  _e252.appendChild(_e255);
  _e251.appendChild(_e252);
  const _e257 = WF.h("p", { className: "wf-text wf-text--muted" }, "Built with WebFluent");
  _e257.style.fontFamily = "JetBrains Mono, monospace";
  _e257.style.color = "#555";
  _e257.style.fontSize = "0.7rem";
  _e257.style.marginTop = "0.5rem";
  _e251.appendChild(_e257);
  _e251.style.padding = "1rem 1.5rem";
  _e251.style.marginTop = "auto";
  _e251.style.borderTop = "1px solid #2D2C2A";
  _e232.appendChild(_e251);
  ...
  const _e258 = WF.h("div", { className: "wf-container" });
  _e258.style.marginLeft = "220px";
  _e258.style.maxWidth = "100%";
  _e258.style.minHeight = "100vh";
  _e258.style.padding = "0";
  _app.appendChild(_e258);
  const _routerEl = document.createElement('div');
  _routerEl.id = 'wf-router';
  _routerEl.style.flex = '1';
  _e258.appendChild(_routerEl);
  const _routes = [
