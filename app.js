...
function Page_Skills(params) {
  ...
  const _e405 = WF.h("p", { className: "wf-text wf-text--bold" }, "Databases & Storage");
  ...
  const _e406 = WF.h("p", { className: "wf-text" }, "PostgreSQL");
  ...
  const _e407 = WF.h("p", { className: "wf-text" }, "MySQL");
  ...
  const _e408 = WF.h("p", { className: "wf-text" }, "MongoDB");
  ...
  const _e409 = WF.h("p", { className: "wf-text" }, "Firebase");
  ...
  const _e410 = WF.h("p", { className: "wf-text" }, "Redis");
  ...
  const _e413 = WF.h("p", { className: "wf-text wf-text--bold" }, "Messaging & Streaming");
  ...
  const _e414 = WF.h("p", { className: "wf-text" }, "Apache Kafka");
  ...
  const _e415 = WF.h("p", { className: "wf-text" }, "RabbitMQ");
  ...
  const _e416 = WF.h("p", { className: "wf-text" }, "Event-Driven Design");
  ...
  const _e417 = WF.h("p", { className: "wf-text" }, "WebSocket");
  ...
  const _e418 = WF.h("p", { className: "wf-text" }, "gRPC");
  ...
  const _e421 = WF.h("p", { className: "wf-text wf-text--bold" }, "Systems & Architecture");
  ...
  const _e422 = WF.h("p", { className: "wf-text" }, "Microservices Architecture");
  ...
  const _e423 = WF.h("p", { className: "wf-text" }, "Distributed Systems");
  ...
  const _e424 = WF.h("p", { className: "wf-text" }, "WebAssembly");
  ...
  const _e425 = WF.h("p", { className: "wf-text" }, "System Design");
  ...
  const _e426 = WF.h("p", { className: "wf-text" }, "Compiler Design");
  ...
  const _e429 = WF.h("p", { className: "wf-text wf-text--bold" }, "DevOps & Infrastructure");
  ...
  const _e430 = WF.h("p", { className: "wf-text" }, "Docker");
  ...
  const _e431 = WF.h("p", { className: "wf-text" }, "Nginx");
  ...
  const _e432 = WF.h("p", { className: "wf-text" }, "Linux");
  ...
  const _e433 = WF.h("p", { className: "wf-text" }, "CI/CD");
  ...
  const _e434 = WF.h("p", { className: "wf-text" }, "Git");
  ...
  const _e437 = WF.h("p", { className: "wf-text wf-text--bold" }, "Frontend & Desktop");
  ...
  const _e438 = WF.h("p", { className: "wf-text" }, "React");
  ...
  const _e439 = WF.h("p", { className: "wf-text" }, "React Native");
  ...
  const _e440 = WF.h("p", { className: "wf-text" }, "Electron");
  ...
  const _e441 = WF.h("p", { className: "wf-text" }, "Tauri");
  ...
  const _e442 = WF.h("p", { className: "wf-text" }, "GTK4 / libadwaita");
  ...
  const _e445 = WF.h("p", { className: "wf-text wf-text--bold" }, "Security & Quality");
  ...
  const _e446 = WF.h("p", { className: "wf-text" }, "AES Encryption");
  ...
  const _e447 = WF.h("p", { className: "wf-text" }, "JWT / OAuth");
  ...
  const _e448 = WF.h("p", { className: "wf-text" }, "Unit Testing");
  ...
  const _e449 = WF.h("p", { className: "wf-text" }, "Code Review");
  ...
  const _e450 = WF.h("p", { className: "wf-text" }, "Agile / Scrum");
  ...
  _e390.classList.add("wf-s451");
  { const _s = document.createElement('style'); _s.textContent = "@media (max-width: 768px) { .wf-s451 { padding: 60px 1.5rem; } } @media (max-width: 480px) { .wf-s451 { padding: 40px 1rem; } } "; document.head.appendChild(_s); }
...
(function() {
  ...
  _app.innerHTML = '';
  const _e452 = WF.h("div", { className: "wf-row wf-row--center wf-row--between" });
  const _e453 = WF.h("a", { className: "wf-link", href: WF._basePath + "/" });
  const _e454 = WF.h("p", { className: "wf-text wf-text--bold" }, "monzer.omer");
  _e454.style.fontFamily = "JetBrains Mono, monospace";
  _e454.style.color = "#E8E6E1";
  _e454.style.fontSize = "0.9rem";
  _e454.style.fontWeight = "600";
  _e453.appendChild(_e454);
  _e452.appendChild(_e453);
  const _e455 = WF.h("button", { className: "wf-btn wf-btn--small wf-btn--outlined", "on:click": (e) => { NavStore.toggle(); } }, "Menu");
  _e455.style.color = "#8C8B88";
  _e455.style.background = "transparent";
  _e455.style.border = "1px solid #2D2C2A";
  _e455.style.cursor = "pointer";
  _e455.style.fontFamily = "JetBrains Mono, monospace";
  _e455.style.fontSize = "0.75rem";
  _e455.style.padding = "0.35rem 0.75rem";
  _e455.style.borderRadius = "0.375rem";
  _e455.classList.add("wf-s456");
  { const _s = document.createElement('style'); _s.textContent = "@media (max-width: 768px) { .wf-s456 { padding: 0.5rem 1rem; font-size: 0.85rem; min-height: 44px; min-width: 44px; } } "; document.head.appendChild(_s); }
  _e452.appendChild(_e455);
  _e452.style.display = "none";
  _e452.style.background = "#1A1A19";
  _e452.style.borderBottom = "1px solid #2D2C2A";
  _e452.style.padding = "0.75rem 1.25rem";
  _e452.style.position = "sticky";
  _e452.style.top = "0";
  _e452.style.zIndex = "200";
  _e452.style.flexDirection = "row";
  _e452.style.flexWrap = "nowrap";
  _e452.classList.add("wf-s457");
  { const _s = document.createElement('style'); _s.textContent = "@media (max-width: 768px) { .wf-s457 { display: flex; } } @media (max-width: 480px) { .wf-s457 { padding: 0.6rem 1rem; } } "; document.head.appendChild(_s); }
  _app.appendChild(_e452);
  WF.condRender(_app,
    () => NavStore.sidebarOpen,
    () => {
      const _e458 = document.createDocumentFragment();
      const _e459 = WF.h("div", { className: "wf-container", "on:click": (event) => { NavStore.close(); } });
      _e459.style.position = "fixed";
      _e459.style.top = "0";
      _e459.style.left = "0";
      _e459.style.right = "0";
      _e459.style.bottom = "0";
      _e459.style.background = "rgba(0, 0, 0, 0.5)";
      _e459.style.zIndex = "399";
      _e459.style.maxWidth = "100%";
      _e459.style.padding = "0";
      _e458.appendChild(_e459);
      const _e460 = WF.h("div", { className: "wf-container" });
      const _e461 = WF.h("div", { className: "wf-container" });
      const _e462 = WF.h("button", { className: "wf-btn wf-btn--small wf-btn--outlined", "on:click": (e) => { NavStore.close(); } }, "✕");
      _e462.style.color = "#8C8B88";
      _e462.style.background = "transparent";
      _e462.style.border = "1px solid #2D2C2A";
      _e462.style.cursor = "pointer";
      _e462.style.fontSize = "0.9rem";
      _e462.style.padding = "0.35rem 0.65rem";
      _e462.style.borderRadius = "0.375rem";
      _e462.style.minHeight = "36px";
      _e462.style.minWidth = "36px";
      _e462.style.lineHeight = "1";
      _e461.appendChild(_e462);
      _e461.style.display = "flex";
      _e461.style.justifyContent = "flex-end";
      _e461.style.padding = "0.75rem 1rem";
      _e461.style.borderBottom = "1px solid #2D2C2A";
      _e460.appendChild(_e461);
      const _e463 = WF.h("div", { className: "wf-container" });
      const _e464 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
      const _e465 = WF.h("a", { className: "wf-link", href: WF._basePath + "/", "on:click": (event) => { NavStore.close(); } });
      const _e466 = WF.h("p", { className: "wf-text wf-text--bold" }, "monzer.omer");
      _e466.style.fontFamily = "JetBrains Mono, monospace";
      _e466.style.color = "#E8E6E1";
      _e466.style.fontSize = "1rem";
      _e466.style.fontWeight = "600";
      _e465.appendChild(_e466);
      _e464.appendChild(_e465);
      const _e467 = WF.h("p", { className: "wf-text wf-text--muted" }, "Senior Backend Engineer");
      _e467.style.color = "#8C8B88";
      _e467.style.fontSize = "0.75rem";
      _e464.appendChild(_e467);
      _e463.appendChild(_e464);
      _e463.style.padding = "1.5rem";
      _e463.style.borderBottom = "1px solid #2D2C2A";
      _e463.style.maxWidth = "100%";
      _e460.appendChild(_e463);
      const _e468 = WF.h("div", { className: "wf-stack" });
      const _e469 = WF.h("a", { className: "wf-link", href: WF._basePath + "/", "on:click": (event) => { NavStore.close(); } });
      const _e470 = WF.h("p", { className: "wf-text" }, "Home");
      _e470.style.display = "block";
      _e470.style.padding = "0.75rem 1.5rem";
      _e470.style.color = "#8C8B88";
      _e470.style.fontSize = "0.95rem";
      _e470.style.minHeight = "44px";
      _e470.style.lineHeight = "1.4";
      _e469.appendChild(_e470);
      _e468.appendChild(_e469);
      const _e471 = WF.h("a", { className: "wf-link", href: WF._basePath + "/projects", "on:click": (event) => { NavStore.close(); } });
      const _e472 = WF.h("p", { className: "wf-text" }, "Projects");
      _e472.style.display = "block";
      _e472.style.padding = "0.75rem 1.5rem";
      _e472.style.color = "#8C8B88";
      _e472.style.fontSize = "0.95rem";
      _e472.style.minHeight = "44px";
      _e472.style.lineHeight = "1.4";
      _e471.appendChild(_e472);
      _e468.appendChild(_e471);
      const _e473 = WF.h("a", { className: "wf-link", href: WF._basePath + "/experience", "on:click": (event) => { NavStore.close(); } });
      const _e474 = WF.h("p", { className: "wf-text" }, "Experience");
      _e474.style.display = "block";
      _e474.style.padding = "0.75rem 1.5rem";
      _e474.style.color = "#8C8B88";
      _e474.style.fontSize = "0.95rem";
      _e474.style.minHeight = "44px";
      _e474.style.lineHeight = "1.4";
      _e473.appendChild(_e474);
      _e468.appendChild(_e473);
      const _e475 = WF.h("a", { className: "wf-link", href: WF._basePath + "/skills", "on:click": (event) => { NavStore.close(); } });
      const _e476 = WF.h("p", { className: "wf-text" }, "Skills");
      _e476.style.display = "block";
      _e476.style.padding = "0.75rem 1.5rem";
      _e476.style.color = "#8C8B88";
      _e476.style.fontSize = "0.95rem";
      _e476.style.minHeight = "44px";
      _e476.style.lineHeight = "1.4";
      _e475.appendChild(_e476);
      _e468.appendChild(_e475);
      const _e477 = WF.h("a", { className: "wf-link", href: WF._basePath + "/education", "on:click": (event) => { NavStore.close(); } });
      const _e478 = WF.h("p", { className: "wf-text" }, "Education");
      ...
      _e468.appendChild(_e477);
      const _e479 = WF.h("a", { className: "wf-link", href: WF._basePath + "/history", "on:click": (event) => { NavStore.close(); } });
      const _e480 = WF.h("p", { className: "wf-text" }, "History");
      ...
      _e468.appendChild(_e479);
      const _e481 = WF.h("a", { className: "wf-link", href: WF._basePath + "/contact", "on:click": (event) => { NavStore.close(); } });
      const _e482 = WF.h("p", { className: "wf-text" }, "Contact");
      ...
      _e468.style.padding = "1rem 0";
      _e468.style.gap = "2px";
      _e460.appendChild(_e468);
      const _e483 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
      const _e484 = WF.h("div", { className: "wf-row wf-row--gap-md" });
      const _e485 = WF.h("a", { className: "wf-link", href: WF._basePath + "https://github.com/monzeromer-lab" });
      const _e486 = WF.h("p", { className: "wf-text" }, "GitHub");
      _e486.style.fontFamily = "JetBrains Mono, monospace";
      _e486.style.color = "#8C8B88";
      _e486.style.fontSize = "0.75rem";
      _e485.appendChild(_e486);
      _e484.appendChild(_e485);
      const _e487 = WF.h("a", { className: "wf-link", href: WF._basePath + "https://www.linkedin.com/in/monzeromer/" });
      const _e488 = WF.h("p", { className: "wf-text" }, "LinkedIn");
      _e488.style.fontFamily = "JetBrains Mono, monospace";
      _e488.style.color = "#8C8B88";
      _e488.style.fontSize = "0.75rem";
      _e487.appendChild(_e488);
      _e484.appendChild(_e487);
      _e483.appendChild(_e484);
      const _e489 = WF.h("p", { className: "wf-text wf-text--muted" }, "Built with WebFluent");
      _e489.style.fontFamily = "JetBrains Mono, monospace";
      _e489.style.color = "#555";
      _e489.style.fontSize = "0.7rem";
      _e489.style.marginTop = "0.5rem";
      _e483.appendChild(_e489);
      _e483.style.padding = "1rem 1.5rem";
      _e483.style.marginTop = "auto";
      _e483.style.borderTop = "1px solid #2D2C2A";
      _e460.appendChild(_e483);
      _e460.style.position = "fixed";
      _e460.style.top = "0";
      _e460.style.left = "0";
      _e460.style.bottom = "0";
      _e460.style.width = "280px";
      _e460.style.maxWidth = "75vw";
      _e460.style.zIndex = "400";
      _e460.style.padding = "0";
      _e460.style.background = "#1A1A19";
      _e460.style.borderRight = "1px solid #2D2C2A";
      _e460.style.overflowY = "auto";
      _e460.style.display = "flex";
      _e460.style.flexDirection = "column";
      _e460.style.boxShadow = "4px 0 24px rgba(0,0,0,0.4)";
      _e460.classList.add("wf-s490");
      { const _s = document.createElement('style'); _s.textContent = "@media (max-width: 400px) { .wf-s490 { width: 100%; max-width: 100vw; } } "; document.head.appendChild(_s); }
      _e458.appendChild(_e460);
      return _e458;
    },
    null,
    null
  );
  const _e491 = WF.h("div", { className: "wf-row" });
  _e491.style.minHeight = "100vh";
  _e491.style.flexDirection = "row";
  _e491.style.flexWrap = "nowrap";
  _app.appendChild(_e491);
  const _e492 = WF.h("div", { className: "wf-container" });
  const _e493 = WF.h("div", { className: "wf-container" });
  const _e494 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
  const _e495 = WF.h("a", { className: "wf-link", href: WF._basePath + "/" });
  const _e496 = WF.h("p", { className: "wf-text wf-text--bold" }, "monzer.omer");
  _e496.style.fontFamily = "JetBrains Mono, monospace";
  _e496.style.color = "#E8E6E1";
  _e496.style.fontSize = "1rem";
  _e496.style.fontWeight = "600";
  _e495.appendChild(_e496);
  _e494.appendChild(_e495);
  const _e497 = WF.h("p", { className: "wf-text wf-text--muted" }, "Senior Backend Engineer");
  _e497.style.color = "#8C8B88";
  _e497.style.fontSize = "0.75rem";
  _e494.appendChild(_e497);
  _e493.appendChild(_e494);
  _e493.style.padding = "1.5rem";
  _e493.style.borderBottom = "1px solid #2D2C2A";
  _e493.style.maxWidth = "100%";
  _e492.appendChild(_e493);
  const _e498 = WF.h("div", { className: "wf-stack" });
  const _e499 = WF.h("a", { className: "wf-link", href: WF._basePath + "/" });
  const _e500 = WF.h("p", { className: "wf-text" }, "Home");
  _e500.style.display = "block";
  _e500.style.padding = "0.55rem 1.5rem";
  _e500.style.color = "#8C8B88";
  _e500.style.fontSize = "0.875rem";
  _e499.appendChild(_e500);
  _e498.appendChild(_e499);
  const _e501 = WF.h("a", { className: "wf-link", href: WF._basePath + "/projects" });
  const _e502 = WF.h("p", { className: "wf-text" }, "Projects");
  _e502.style.display = "block";
  _e502.style.padding = "0.55rem 1.5rem";
  _e502.style.color = "#8C8B88";
  _e502.style.fontSize = "0.875rem";
  _e501.appendChild(_e502);
  _e498.appendChild(_e501);
  const _e503 = WF.h("a", { className: "wf-link", href: WF._basePath + "/experience" });
  const _e504 = WF.h("p", { className: "wf-text" }, "Experience");
  _e504.style.display = "block";
  _e504.style.padding = "0.55rem 1.5rem";
  _e504.style.color = "#8C8B88";
  _e504.style.fontSize = "0.875rem";
  _e503.appendChild(_e504);
  _e498.appendChild(_e503);
  const _e505 = WF.h("a", { className: "wf-link", href: WF._basePath + "/skills" });
  const _e506 = WF.h("p", { className: "wf-text" }, "Skills");
  _e506.style.display = "block";
  _e506.style.padding = "0.55rem 1.5rem";
  _e506.style.color = "#8C8B88";
  _e506.style.fontSize = "0.875rem";
  _e505.appendChild(_e506);
  _e498.appendChild(_e505);
  const _e507 = WF.h("a", { className: "wf-link", href: WF._basePath + "/education" });
  const _e508 = WF.h("p", { className: "wf-text" }, "Education");
  ...
  _e498.appendChild(_e507);
  const _e509 = WF.h("a", { className: "wf-link", href: WF._basePath + "/history" });
  const _e510 = WF.h("p", { className: "wf-text" }, "History");
  ...
  _e498.appendChild(_e509);
  const _e511 = WF.h("a", { className: "wf-link", href: WF._basePath + "/contact" });
  const _e512 = WF.h("p", { className: "wf-text" }, "Contact");
  ...
  _e498.appendChild(_e511);
  _e498.style.padding = "1rem 0";
  _e498.style.gap = "2px";
  _e492.appendChild(_e498);
  const _e513 = WF.h("div", { className: "wf-stack wf-stack--gap-sm" });
  const _e514 = WF.h("div", { className: "wf-row wf-row--gap-md" });
  const _e515 = WF.h("a", { className: "wf-link", href: WF._basePath + "https://github.com/monzeromer-lab" });
  const _e516 = WF.h("p", { className: "wf-text" }, "GitHub");
  _e516.style.fontFamily = "JetBrains Mono, monospace";
  _e516.style.color = "#8C8B88";
  _e516.style.fontSize = "0.75rem";
  _e515.appendChild(_e516);
  _e514.appendChild(_e515);
  const _e517 = WF.h("a", { className: "wf-link", href: WF._basePath + "https://www.linkedin.com/in/monzeromer/" });
  const _e518 = WF.h("p", { className: "wf-text" }, "LinkedIn");
  _e518.style.fontFamily = "JetBrains Mono, monospace";
  _e518.style.color = "#8C8B88";
  _e518.style.fontSize = "0.75rem";
  _e517.appendChild(_e518);
  _e514.appendChild(_e517);
  _e513.appendChild(_e514);
  const _e519 = WF.h("p", { className: "wf-text wf-text--muted" }, "Built with WebFluent");
  _e519.style.fontFamily = "JetBrains Mono, monospace";
  _e519.style.color = "#555";
  _e519.style.fontSize = "0.7rem";
  _e519.style.marginTop = "0.5rem";
  _e513.appendChild(_e519);
  _e513.style.padding = "1rem 1.5rem";
  _e513.style.marginTop = "auto";
  _e513.style.borderTop = "1px solid #2D2C2A";
  _e492.appendChild(_e513);
  _e492.style.width = "220px";
  _e492.style.minWidth = "220px";
  _e492.style.maxWidth = "220px";
  _e492.style.padding = "0";
  _e492.style.position = "sticky";
  _e492.style.top = "0";
  _e492.style.height = "100vh";
  _e492.style.background = "#1A1A19";
  _e492.style.borderRight = "1px solid #2D2C2A";
  _e492.style.overflowY = "auto";
  _e492.style.display = "flex";
  _e492.style.flexDirection = "column";
  _e492.style.flexShrink = "0";
  _e492.classList.add("wf-s520");
  { const _s = document.createElement('style'); _s.textContent = "@media (max-width: 768px) { .wf-s520 { display: none; } } "; document.head.appendChild(_s); }
  _e491.appendChild(_e492);
  const _e521 = WF.h("div", { className: "wf-container" });
  _e521.style.flex = "1";
  _e521.style.maxWidth = "100%";
  _e521.style.minHeight = "100vh";
  _e521.style.padding = "0";
  _e521.style.minWidth = "0";
  _e491.appendChild(_e521);
  const _routerEl = document.createElement('div');
  _routerEl.id = 'wf-router';
  _routerEl.style.flex = '1';
  _e521.appendChild(_routerEl);
  const _routes = [
